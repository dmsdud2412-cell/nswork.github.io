...
function renderTable(attendance) {
    ...
    const holidayInfo = { 1: { 1: "신정" }, 2: { 16: " ", 17: "설날", 18: " " }, 3: { 1: "삼일절", 2: "대체 휴일"  }, 5: { 1: "노동절", 5: "어린이날", 24: "석가 탄신일", 25: "대체 휴일" }, 6: { 3: "지방 선거", 6: "현충일" }, 7: { 17: "제헌절" }, 8: { 15: "광복절", 17: "대체 휴일"  }, 9: { 18: "창립 기념일", 24: " ", 25: "추석"  }, 10: { 3: "개천절", 5: "대체 휴일", 9: "한글날" }, 12: { 25: "성탄절", 31: "단체 연차"  } }[currentMonth] || {};
